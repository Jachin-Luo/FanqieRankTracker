...
# 男频赛道分组（基于番茄男频常见分类，待 discover 拿到真实分类名后校准）
MALE_GENRE_GROUPS = [
    {"name": "玄幻仙侠", "categories": ["东方玄幻", "异世大陆", "高武世界", "修真文明", "古典仙侠", "幻想修仙"]},
    {"name": "都市现实", "categories": ["都市生活", "都市异能", "异术超能", "商战职场", "娱乐明星"]},
    {"name": "历史军事", "categories": ["架空历史", "历史脑洞", "两宋元明", "军事战争", "谍战特工"]},
    {"name": "科幻末世", "categories": ["未来世界", "星际文明", "末世危机", "进化变异", "时空穿梭"]},
    {"name": "悬疑灵异", "categories": ["悬疑探案", "诡秘惊悚", "规则怪谈", "灵异神怪", "盗墓探险"]},
    {"name": "游戏竞技", "categories": ["虚拟网游", "电子竞技", "游戏异界", "体育竞技"]},
]
